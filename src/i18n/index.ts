...
const resources = {
  en: {
    translation: {
      ...
      importLocalTip: "Select local folder path, must contain SKILL.md or skill.md file",
      repoMustContainSkill: "Repository must contain SKILL.md or skill.md file",
      folderMustContainSkill: "Folder must contain SKILL.md or skill.md file",
  ...
  zh: {
    translation: {
      ...
      importLocalTip: "选择本地文件夹路径，必须包含 SKILL.md 或 skill.md 文件",
      repoMustContainSkill: "仓库必须包含 SKILL.md 或 skill.md 文件",
      folderMustContainSkill: "文件夹必须包含 SKILL.md 或 skill.md 文件",
