...
const resources = {
  en: {
    translation: {
      ...
      importLocalTip: "Select a local folder or ZIP file containing SKILL.md or skill.md",
      repoMustContainSkill: "Repository must contain SKILL.md or skill.md file",
      folderMustContainSkill: "Folder or ZIP must contain SKILL.md or skill.md file",
      ...
      'error.skillMdNotFound': 'SKILL.md / skill.md not found',
      'error.zipExtractFailed': 'Failed to extract ZIP file',
      'error.invalidZipFile': 'Invalid ZIP file',
  ...
  zh: {
    translation: {
      ...
      importLocalTip: "选择本地文件夹或 ZIP 压缩包，需包含 SKILL.md 或 skill.md 文件",
      repoMustContainSkill: "仓库必须包含 SKILL.md 或 skill.md 文件",
      folderMustContainSkill: "文件夹或 ZIP 压缩包必须包含 SKILL.md 或 skill.md 文件",
      ...
      'error.skillMdNotFound': '未找到 SKILL.md / skill.md 文件',
      'error.zipExtractFailed': 'ZIP 解压失败',
      'error.invalidZipFile': '无效的 ZIP 文件',
      repoNotFound: '仓库不存在',
